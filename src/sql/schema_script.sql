create edition loc_feat_edition
as child of ora$base;

alter session set edition=loc_feat_edition;

alter table webapp.order_details
...
create table webapp.DeliveryLocations(
  loc_id number(2) PRIMARY KEY,
  loc_name varchar2(50) NOT NULL
) tablespace "USERS";


INSERT INTO "WEBAPP"."DELIVERYLOCATIONS" (LOC_ID, LOC_NAME) VALUES ('1', 'SF Bay Area');
INSERT INTO "WEBAPP"."DELIVERYLOCATIONS" (LOC_ID, LOC_NAME) VALUES ('2', 'New York City');
INSERT INTO "WEBAPP"."DELIVERYLOCATIONS" (LOC_ID, LOC_NAME) VALUES ('3', 'Miami');
INSERT INTO "WEBAPP"."DELIVERYLOCATIONS" (LOC_ID, LOC_NAME) VALUES ('4', 'Seattle');
INSERT INTO "WEBAPP"."DELIVERYLOCATIONS" (LOC_ID, LOC_NAME) VALUES ('5', 'Austin');
...
add constraint fk_loc
  ...
  REFERENCES webapp.DeliveryLocations(loc_id);
